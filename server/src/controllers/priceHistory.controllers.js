...
const createORupdatePriceHistory=async(req, res ,next)=>{
  try {
...
const listPriceHistory=async(req, res, next)=>{
try {
...
export {createORupdatePriceHistory, listPriceHistory, getPriceHistory}